...
int main() {
    ...
    // CTCBeamSearch* decoder = new CTCBeamSearch(vocab, vocab_size + 1, 2, 0);
    
    CTCBeamSearch* decoder = new CTCBeamSearch(vocab, 4, 2, 0);
    ...
    seqProb->toGpu();
    vector<pair<string, float>> bestResults = decoder->decode(seqProb, 10, 1);
